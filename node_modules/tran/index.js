...
// var HOST = 'http://sdk.open.api.igexin.com/apiex.htm';
	this.host = 'https://api.getui.com/apiex.htm';
	this.appId = 'eECHDNfs5Z680lzQMEHCt6';
	this.appKey = 'CcArSfD8IrA7l8diZDxw46';
	this.masterSecret = 'VDLFyCWoyd9onOrmCP4m78'; // 'cUGtB5Rjqk8A2yFsugEU0A';
	this.title = "智能家居警报";
